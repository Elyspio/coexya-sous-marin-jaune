		...
		<Stack direction={"row"} spacing={2} alignItems={"center"}>
			...
			<Fade in={!!data.fries}>
				<FormControl fullWidth>
					<InputLabel id="select-sauces-label" sx={{ mr: 1, ml: 0 }}>
						Sauces
					</InputLabel>
					<Select labelId="select-sauces-label" id="select-sauces" value={data.fries?.sauces ?? []} label="Sauces" multiple variant={"standard"} onChange={setFries}>
